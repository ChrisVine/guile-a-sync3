...
;; which is exported publicly in case it is useful to users.  In
;; consequence, consider using the support for g-golf and guile-gi
;; which is provided by guile-a-sync3 instead.
;;
