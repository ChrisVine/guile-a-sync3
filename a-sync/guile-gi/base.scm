...
(define-module (a-sync guile-gi base)
...
(define (glib-timeout-add msecs proc)
...
;; out of main-loop:run.  Exceptions thrown by 'proc', if not caught
;; locally, will also propagate out of main-loop:run.
...
;; caught locally, will propagate out of main-loop:run.
...
;; not caught locally, will propagate out of main-loop:run.
